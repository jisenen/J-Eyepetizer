...
import com.mylearn.jeyepetizer.common.ui.ShareDialogFragment
 ...
 */
val sharedPreferences: SharedPreferences = MyApplication.context.getSharedPreferences(GlobalUtil.appPackage + "_preferences", Context.MODE_PRIVATE)
