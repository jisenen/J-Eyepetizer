...
object ShareUtil {
        ...
        when (shareType) {
            SHARE_QQ -> {
                if (!GlobalUtil.isQQInstalled()) {
                    GlobalUtil.getString(R.string.your_phone_does_not_install_qq).showShortToast()
                    return
                }
                share(
                    activity,
            ...
            SHARE_WECHAT -> {
                if (!GlobalUtil.isWechatInstalled()) {
                    GlobalUtil.getString(R.string.your_phone_does_not_install_wechat).showShortToast()
                    return
                }
                share(
                    activity,
            ...
            SHARE_WEIBO -> {
                if (!GlobalUtil.isWeiboInstalled()) {
                    GlobalUtil.getString(R.string.your_phone_does_not_install_weibo).showShortToast()
                    return
                }
                share(
                    activity,
            ...
            SHARE_QQZONE -> {
                if (!GlobalUtil.isWeiboInstalled()) {
                    GlobalUtil.getString(R.string.your_phone_does_not_install_qq_zone).showShortToast()
                    return
                }
                share(
                    activity,
    ...
    private fun share(activity: Activity, shareContent: String, packageName: String, className: String) {
        try {
            ...
            GlobalUtil.getString(R.string.share_unknown_error).showShortToast()
        }
    }
