...
class EyepetizerNetwork {
    ...
    private val mainPageService = NetServiceCreator.create(MainPageService::class.java)

    private val videoService = NetServiceCreator.create(VideoService::class.java)
