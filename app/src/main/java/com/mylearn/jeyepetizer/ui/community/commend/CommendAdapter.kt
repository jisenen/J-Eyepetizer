...
class CommendAdapter(val fragment: CommendFragment, var dataList: List<CommunityRecommend.Item>) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int) = when (viewType) {
        ...
        HORIZONTAL_SCROLLCARD_TYPE -> {
            HorizontalScrollcardViewHolder(
                R.layout.item_community_horizontal_scrollcard_type.inflate(parent)
            )
        }
        FOLLOW_CARD_TYPE -> {
            FollowCardViewHolder(
                R.layout.item_community_columns_card_follow_card_type.inflate(parent)
            )
        }
        else -> {
    ...
    inner class BannerAdapter :
        ...
        inner class ViewHolder(val view: View) :
            BaseViewHolder<CommunityRecommend.ItemX>(view) {
            override fun bindData(
                item: CommunityRecommend.ItemX,
                position: Int,
                pageSize: Int
            ) {
        ...
        override fun getLayoutId(viewType: Int): Int = R.layout.item_banner_item_type
